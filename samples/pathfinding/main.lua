...
grid:setRow ( 3,	0x03, 0x03, 0x00, 0x03, 0x00, 0x00, 0x03, 0x03 )
grid:setRow ( 4,	0x03, 0x03, 0x03, 0x03, 0x03, 0x00, 0x03, 0x03 )
grid:setRow ( 5,	0x03, 0x03, 0x00, 0x00, 0x03, 0x00, 0x03, 0x03 )
grid:setRow ( 6,	0x03, 0x03, 0x00, 0x03, 0x03, 0x00, 0x03, 0x03 )
grid:setRow ( 7,	0x03, 0x00, 0x03, 0x03, 0x03, 0x00, 0x03, 0x03 )
grid:setRow ( 8,	0x03, 0x00, 0x03, 0x03, 0x03, 0x00, 0x03, 0x03 )
